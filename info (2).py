...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://larib82632:larib82632@cluster0.rj7ed.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'fileprop') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movie_Request_Group_23') # Support Chat Link Without https:// or @
